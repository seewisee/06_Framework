...
// @RequestMapping(value = "요청주소", method = RequestMeethod.GET/POST)
// -> GET / POST 방식을 구분
...
public class MemberController {
	...
	public String login(Member inputMember, Model model,
		...
		// -> name 속성값이 "saveId"인 파라미터를 전달 받아 저장
		...
		if(loginMember != null) { //  로그인 성공 시
			...
			// servlet -> HttpSession.setAtttribute(key, value);
